...
$courseTitle = "Curso de Presentaciones exitosas y claras";
$courseUrl = "http://localhost/PLANIFICAME/views/courses/habilidadesBlandas/Curso_de_Presentaciones_exitosas_y_claras.php";  // URL fija del curso
