...
$courseTitle = "Curso de Toma de decisiones bajo presion";
$courseUrl = "http://localhost/PLANIFICAME/views/courses/habilidadesBlandas/Curso_de_Toma_de_decisiones_bajo_presion.php";  // URL fija del curso
