...
$courseTitle = "Curso de Colaboracion y resolucion de conflictos";
$courseUrl = "http://localhost/PLANIFICAME/views/courses/habilidadesBlandas/Curso_de_Colaboracion_y_resolucion_de_conflictos.php";  // URL fija del curso
