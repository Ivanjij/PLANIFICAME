...
$courseTitle = "Curso de Trabajo multidisciplinario eficaz";
$courseUrl = "http://localhost/PLANIFICAME/views/courses/habilidadesBlandas/Curso_de_Trabajo_multidisciplinario_eficaz.php";  // URL fija del curso
