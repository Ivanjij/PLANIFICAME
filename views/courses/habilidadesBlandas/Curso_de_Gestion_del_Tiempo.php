...
$courseTitle = "Curso de Gestion del Tiempo";
$courseUrl = "http://localhost/PLANIFICAME/views/courses/habilidadesBlandas/Curso_de_Gestion_del_Tiempo.php";  // URL fija del curso
