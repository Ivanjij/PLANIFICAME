...
$courseTitle = "Curso de Equilibrio entre trabajo y vida personal";
$courseUrl = "http://localhost/PLANIFICAME/views/courses/habilidadesBlandas/Curso_de_Equilibrio_entre_trabajo_y_vida_personal.php";  // URL fija del curso
